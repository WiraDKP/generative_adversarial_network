# Generative Adversarial Network by J.COp

# Starter Guide
## Step 1: Download materi
- Klik disini untuk [Download ZIP](https://codeload.github.com/WiraDKP/generative_adversarial_network/zip/master), atau
- Bagi yang familiar dengan git, boleh menggunakan clone
    ```
    git clone https://github.com/WiraDKP/generative_adversarial_network.git
    ```
...
- Change directory `cd` ke folder kerja ini
    ...
    ```
- Jalankan command ini untuk menginstall environment `jcop_gan`
    ```
    conda env create -f env_jcop_gan.yml
    ```
...
- Jika sudah aman, maka akan muncul keterangan berikut, dan kita bisa mulai belajar. Semangat!
    ...
    ✓ Package telah terinstall dengan baik di dalam environment jcop_gan
